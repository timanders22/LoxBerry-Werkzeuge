#!/usr/bin/env python3
"""Erzeugt die Sprachdateien des Audi-Connect-Plugins.
...
1. Doppelte Maskierung. Ein Text, der durch au_e() laeuft und selbst eine
...
Aufruf:  au_sprache_erzeugen.py <pluginordner> [--pruefen]
"""
...
"EINST.DIENST_ERKLAERUNG": "Der Dienst holt die Werte im eingestellten Takt aus der Audi-Schnittstelle und legt sie ab. Oberfl&auml;che und Miniserver lesen nur das Abgelegte &mdash; sie sprechen nie selbst mit dem Anbieter.",
...
"EINST.H_KONTO": "Zugang zum Audi-Konto",
"EINST.KONTO_ERKLAERUNG": "Es sind die Zugangsdaten des <b>myAudi-Kontos</b> &mdash; dieselben, mit denen Sie sich in der myAudi-App anmelden. Nicht die eines H&auml;ndlerportals. Sie werden in einer eigenen Datei mit den Rechten 0600 abgelegt, nicht in der Konfiguration, die diese Seite anzeigt. <b>Zwei Hinweise:</b> Der Connector spricht mit dem <b>europ&auml;ischen</b> Dienst. Und einzelne Konten verlangen eine Zwei-Faktor-Best&auml;tigung; die l&auml;sst sich nicht automatisieren. Wer davon betroffen ist, meldet sich einmal im Browser auf diesem Ger&auml;t an.",
"EINST.L_EMAIL": "Benutzername (E-Mail-Adresse)",
"EINST.H_EMAIL": "Die E-Mail-Adresse, mit der das myAudi-Konto angelegt wurde.",
...
"EINST.H_SPIN": "Die vierstellige S-PIN aus der myAudi-App. Dieses Plugin bietet <b>kein</b> Ver- oder Entriegeln und keine Hupe an und braucht sie deshalb nicht; das Feld ist f&uuml;r eine sp&auml;tere Fassung vorbereitet. Wer sie nicht braucht, l&auml;sst es leer.",
...
"EINST.TAKT_WARNUNG": "<b>Untergrenze 180 Sekunden.</b> Der Audi-Connector nimmt darunter gar nichts an &mdash; er wirft beim Anlegen einen Fehler. Und auch dar&uuml;ber gilt: zu h&auml;ufige Anfragen weist Audi mit HTTP 429 ab, und ein st&auml;ndig geweckter Wagen kostet Ruhestrom. F&uuml;nf Minuten sind ein guter Anfang. Wird ein Wert sofort gebraucht, ist der Abruf-Befehl der richtige Weg, nicht ein k&uuml;rzerer Takt.",
...
"EINST.VIN_HINWEIS": "In allen Adressen kann statt der Nummer auch die Fahrgestellnummer stehen &mdash; <span class='sm-mono'>fahrzeug=WAU…</span>. Das ist stabiler, wenn sp&auml;ter ein zweites Fahrzeug ins Konto kommt und sich die Reihenfolge verschiebt.",
...
"BAUSTEIN.N33": "Audi Klima ein",
"BAUSTEIN.P33": "Befehl bei EIN, Adresse aus Schritt 5",
"BAUSTEIN.N34": "Audi Klima aus",
...
"TEST.H_PROZENT": "Zul&auml;ssig sind 10 bis 100. Audi rundet auf die Stufen, die das Fahrzeug kennt &mdash; meist Zehnerschritte.",
...
"AU_FELD.SOC": "Ladezustand der Antriebsbatterie",
"AU_FELD.TANK": "Tankfüllstand",
"AU_FELD.REICHW": "Gesamtreichweite",
"AU_FELD.KM": "Kilometerstand",
"AU_FELD.VERR": "1 = verriegelt, 0 = nicht verriegelt",
"AU_FELD.TUEREN": "1 = mindestens eine Tür offen",
"AU_FELD.FENSTER": "1 = mindestens ein Fenster offen",
"AU_FELD.LICHT": "1 = Licht an",
"AU_FELD.KLIMA": "1 = Klimatisierung läuft (auch Lüften und Zusatzheizen)",
"AU_FELD.ZIELTEMP": "Eingestellte Zieltemperatur der Klimatisierung",
"AU_FELD.AUSSEN": "Außentemperatur, vom Fahrzeug gemessen",
"AU_FELD.ERREICH": "1 = das Fahrzeug ist für die Cloud erreichbar",
"AU_FELD.ALTER": "Alter des Abbilds — für die Ausfallerkennung",
"AU_FELD.OK": "1 = der letzte Abruf war erfolgreich",

# ---- Feldbedeutungen (Laden) ----------------------------------------------
"AU_LFELD.SOC": "Ladezustand der Antriebsbatterie",
"AU_LFELD.LAEDT": "1 = wird gerade geladen",
"AU_LFELD.LADEKW": "Aktuelle Ladeleistung",
"AU_LFELD.TEMPO": "Zugewinn an Reichweite je Stunde",
"AU_LFELD.LADEGR": "Eingestellte Ladegrenze",
"AU_LFELD.KABEL": "1 = Ladekabel steckt",
"AU_LFELD.REICHWBAT": "Reichweite allein aus der Batterie",
"AU_LFELD.OK": "1 = der letzte Abruf war erfolgreich",

# ---- Feldbedeutungen (Wartung) --------------------------------------------
"AU_WFELD.INSPTAGE": "Tage bis zur nächsten Inspektion",
"AU_WFELD.INSPKM": "Kilometer bis zur nächsten Inspektion",
"AU_WFELD.OELTAGE": "Tage bis zum nächsten Ölservice",
"AU_WFELD.OELKM": "Kilometer bis zum nächsten Ölservice",
"AU_WFELD.KM": "Kilometerstand",
"AU_WFELD.OK": "1 = der letzte Abruf war erfolgreich",

# ---- MQTT-Themen -----------------------------------------------------------
"AU_MQTT.OK": "1 = der letzte Abruf war erfolgreich",
"AU_MQTT.FAHRZEUGE": "Anzahl der Fahrzeuge im Konto",
"AU_MQTT.SOC": "Ladezustand der Antriebsbatterie in Prozent",
"AU_MQTT.REICHWEITE": "Gesamtreichweite in km",
"AU_MQTT.TANK": "Tankfüllstand in Prozent",
"AU_MQTT.KM": "Kilometerstand",
"AU_MQTT.VERRIEGELT": "1 = verriegelt",
"AU_MQTT.TUEREN": "1 = mindestens eine Tür offen",
"AU_MQTT.FENSTER": "1 = mindestens ein Fenster offen",
"AU_MQTT.LICHT": "1 = Licht an",
"AU_MQTT.KLIMA": "1 = Klimatisierung läuft",
"AU_MQTT.ZIELTEMP": "Zieltemperatur in Grad Celsius",
"AU_MQTT.AUSSEN": "Außentemperatur in Grad Celsius",
"AU_MQTT.LAEDT": "1 = wird gerade geladen",
"AU_MQTT.LADEKW": "Ladeleistung in kW",
"AU_MQTT.LADEGRENZE": "Eingestellte Ladegrenze in Prozent",
"AU_MQTT.KABEL": "1 = Ladekabel steckt",
"AU_MQTT.BREITE": "Breitengrad des Standorts",
"AU_MQTT.LAENGE": "Längengrad des Standorts",
"AU_MQTT.INSP_TAGE": "Tage bis zur Inspektion",
"AU_MQTT.INSP_KM": "Kilometer bis zur Inspektion",
"AU_MQTT.OEL_TAGE": "Tage bis zum Ölservice",
"AU_MQTT.OEL_KM": "Kilometer bis zum Ölservice",
"AU_MQTT.ERREICHBAR": "1 = für die Cloud erreichbar",
"EINST.SITZUNG_ERKLAERUNG": "Nach der ersten Anmeldung legt die Bibliothek Anmeldemarken in einer eigenen Datei mit den Rechten 0600 ab und meldet sich damit an, statt jedes Mal das Passwort zu senden. Das schont die Anmeldeseite von Audi, die wiederholte Anmeldungen drosselt. Nach einem Passwortwechsel sind die Marken wertlos &mdash; dann hilft der Knopf <i>Anmeldung neu erzwingen</i> oben.",
...
"TEST.F_CONNECTOR": "Ist der Audi-Connector geladen? (jung, eigener Betreuer)",
"TEST.F_MARKE": "Sind die Anmeldemarken vor fremden Blicken geschützt?",
"TEST.H_AMPERE": "Welche Stufen Ihr Fahrzeug kennt, h&auml;ngt vom Modell ab: manche f&uuml;hren den Strom in Ampere (5, 10, 13, 32), die &uuml;brigen kennen nur reduziert (6) und maximal (16). Eine unbekannte Stufe weist Audi ab &mdash; die Ablehnung steht dann in der Meldung.",
"TEST.K_LADESTROM": "Ladestrom setzen",
"TEST.L_AMPERE": "Ladestrom",
"TEST.M_AMPERE_UNGUELTIG": "Der Ladestrom muss eine ganze Zahl sein.",
"AU_FELD.HANDBR": "1 = Handbremse angezogen",
"AU_FELD.SCHEIBE": "1 = Scheibenheizung an",
"AU_FELD.ZUSTAND": "0 = offline, 1 = geparkt, 2 = Zündung an, 3 = fährt",
"AU_LFELD.FERTIGMIN": "Minuten bis zum voraussichtlichen Ladeende",
"AU_LFELD.LADESTROM": "Eingestellter maximaler Ladestrom",
"AU_LFELD.STECKER": "1 = Stecker im Fahrzeug verriegelt",
"AU_MQTT.FERTIG": "Voraussichtliches Ladeende als Unix-Zeit",
"AU_MQTT.HANDBREMSE": "1 = Handbremse angezogen",
"AU_MQTT.LADESTROM": "Eingestellter maximaler Ladestrom in Ampere",
"AU_MQTT.SCHEIBE": "1 = Scheibenheizung an",
"AU_MQTT.STECKER": "1 = Stecker im Fahrzeug verriegelt",
"AU_MQTT.TEMPO": "Zugewinn an Reichweite je Stunde in km/h",
"AU_MQTT.ZUSTAND": "0 = offline, 1 = geparkt, 2 = Zündung an, 3 = fährt",
}
...
"EINST.DIENST_ERKLAERUNG": "The service fetches values from the Audi cloud at the configured interval and stores them. The user interface and the Miniserver only read what has been stored &mdash; they never talk to the provider themselves.",
...
"EINST.H_KONTO": "Audi account access",
"EINST.KONTO_ERKLAERUNG": "These are the credentials of your <b>myAudi account</b> &mdash; the same ones you use in the myAudi app. Not those of a dealer portal. They are stored in a separate file with mode 0600, not in the configuration this page displays. <b>Two notes:</b> the connector talks to the <b>European</b> service. And some accounts ask for two-factor confirmation, which cannot be automated; if that affects you, sign in once in a browser on this machine.",
"EINST.L_EMAIL": "Username (e-mail address)",
"EINST.H_EMAIL": "The e-mail address the myAudi account was created with.",
...
"EINST.H_SPIN": "The four-digit S-PIN from the myAudi app. This plugin offers <b>no</b> locking, unlocking or horn and therefore does not need it; the field is prepared for a later version. Leave it empty if you do not need it.",
"EINST.SPIN_GESETZT": "stored – leave empty to keep it",
"EINST.SPIN_LEER": "no S-PIN stored",

"EINST.H_TAKT": "Polling interval",
"EINST.TAKT_WARNUNG": "<b>Lower limit 180 seconds.</b> The Audi connector refuses anything below that &mdash; it raises an error on creation. And above it the same applies: Audi rejects frequent requests with HTTP 429, and a car that is woken constantly draws standby current. Five minutes is a good start. If you need a value right now, use the poll command, not a shorter interval.",
...
"EINST.VIN_HINWEIS": "Every address also accepts the VIN instead of the number &mdash; <span class='sm-mono'>fahrzeug=WAU…</span>. That is more robust if a second vehicle is added to the account later and the order shifts.",
...
"BAUSTEIN.N33": "Audi air conditioning on",
"BAUSTEIN.P33": "command on ON, address from step 5",
"BAUSTEIN.N34": "Audi air conditioning off",
...
"TEST.H_PROZENT": "Allowed: 10 to 100. Audi rounds to the steps the car supports &mdash; usually multiples of ten.",
...
"TEST.UNGEPRUEFT": "This plugin was built <b>without a myAudi account and without a car</b>. Unverified is therefore: whether signing in succeeds, whether this vehicle supplies the requested values, and whether the write commands have the expected effect. Everything else has been verified &mdash; and not against mock objects: the value mapping and the write commands were measured against <b>real library objects</b>. <b>A second reservation applies here:</b> the Audi connector is considerably younger than the Volkswagen one (first release 28 September 2025, eight releases up to 0.3.2) and has a different maintainer. The framework beneath it is the same and mature, the Audi part is not to the same degree. That is why this version is numbered 0.9.0 and not 1.0.0. If something stays empty, the button <i>View raw data as JSON</i> helps: it shows what the service actually received.",
...
"AU_FELD.SOC": "State of charge of the traction battery",
"AU_FELD.TANK": "Fuel level",
"AU_FELD.REICHW": "Total range",
"AU_FELD.KM": "Odometer",
"AU_FELD.VERR": "1 = locked, 0 = not locked",
"AU_FELD.TUEREN": "1 = at least one door open",
"AU_FELD.FENSTER": "1 = at least one window open",
"AU_FELD.LICHT": "1 = lights on",
"AU_FELD.KLIMA": "1 = air conditioning running (including ventilation and auxiliary heating)",
"AU_FELD.ZIELTEMP": "Configured target temperature of the air conditioning",
"AU_FELD.AUSSEN": "Outside temperature as measured by the car",
"AU_FELD.ERREICH": "1 = the car is reachable for the cloud",
"AU_FELD.ALTER": "Age of the snapshot — for failure detection",
"AU_FELD.OK": "1 = the last poll succeeded",

"AU_LFELD.SOC": "State of charge of the traction battery",
"AU_LFELD.LAEDT": "1 = charging right now",
"AU_LFELD.LADEKW": "Current charging power",
"AU_LFELD.TEMPO": "Range gained per hour",
"AU_LFELD.LADEGR": "Configured charge limit",
"AU_LFELD.KABEL": "1 = charging cable plugged in",
"AU_LFELD.REICHWBAT": "Range from the battery alone",
"AU_LFELD.OK": "1 = the last poll succeeded",

"AU_WFELD.INSPTAGE": "Days until the next inspection",
"AU_WFELD.INSPKM": "Kilometres until the next inspection",
"AU_WFELD.OELTAGE": "Days until the next oil service",
"AU_WFELD.OELKM": "Kilometres until the next oil service",
"AU_WFELD.KM": "Odometer",
"AU_WFELD.OK": "1 = the last poll succeeded",

"AU_MQTT.OK": "1 = the last poll succeeded",
"AU_MQTT.FAHRZEUGE": "Number of vehicles in the account",
"AU_MQTT.SOC": "State of charge of the traction battery in percent",
"AU_MQTT.REICHWEITE": "Total range in km",
"AU_MQTT.TANK": "Fuel level in percent",
"AU_MQTT.KM": "Odometer",
"AU_MQTT.VERRIEGELT": "1 = locked",
"AU_MQTT.TUEREN": "1 = at least one door open",
"AU_MQTT.FENSTER": "1 = at least one window open",
"AU_MQTT.LICHT": "1 = lights on",
"AU_MQTT.KLIMA": "1 = air conditioning running",
"AU_MQTT.ZIELTEMP": "Target temperature in degrees Celsius",
"AU_MQTT.AUSSEN": "Outside temperature in degrees Celsius",
"AU_MQTT.LAEDT": "1 = charging right now",
"AU_MQTT.LADEKW": "Charging power in kW",
"AU_MQTT.LADEGRENZE": "Configured charge limit in percent",
"AU_MQTT.KABEL": "1 = charging cable plugged in",
"AU_MQTT.BREITE": "Latitude of the location",
"AU_MQTT.LAENGE": "Longitude of the location",
"AU_MQTT.INSP_TAGE": "Days until the inspection",
"AU_MQTT.INSP_KM": "Kilometres until the inspection",
"AU_MQTT.OEL_TAGE": "Days until the oil service",
"AU_MQTT.OEL_KM": "Kilometres until the oil service",
"AU_MQTT.ERREICHBAR": "1 = reachable for the cloud",
"EINST.SITZUNG_ERKLAERUNG": "After the first login the library stores authentication tokens in a separate file with mode 0600 and uses them instead of sending the password every time. This spares the Audi login page, which throttles repeated sign-ins. After a password change the tokens are worthless &mdash; then use the <i>Force a new login</i> button above.",
...
"TEST.F_CONNECTOR": "Is the Audi connector loaded? (young, separate maintainer)",
"TEST.F_MARKE": "Are the authentication tokens protected from other users?",
"TEST.H_AMPERE": "Which steps your car supports depends on the model: some handle the current in amperes (5, 10, 13, 32), the rest only know reduced (6) and maximum (16). Audi rejects an unknown step &mdash; the rejection then appears in the message.",
...
"AU_FELD.HANDBR": "1 = parking brake engaged",
"AU_FELD.SCHEIBE": "1 = window heating on",
"AU_FELD.ZUSTAND": "0 = offline, 1 = parked, 2 = ignition on, 3 = driving",
"AU_LFELD.FERTIGMIN": "Minutes until charging is expected to finish",
"AU_LFELD.LADESTROM": "Configured maximum charging current",
"AU_LFELD.STECKER": "1 = plug locked in the vehicle",
"AU_MQTT.FERTIG": "Expected end of charging as Unix time",
"AU_MQTT.HANDBREMSE": "1 = parking brake engaged",
"AU_MQTT.LADESTROM": "Configured maximum charging current in amperes",
"AU_MQTT.SCHEIBE": "1 = window heating on",
"AU_MQTT.STECKER": "1 = plug locked in the vehicle",
"AU_MQTT.TEMPO": "Range gained per hour in km/h",
"AU_MQTT.ZUSTAND": "0 = offline, 1 = parked, 2 = ignition on, 3 = driving",
}

KOPF_DE = """; Audi Connect - Deutsch
;
; ERZEUGT von Werkzeuge/au_sprache_erzeugen.py - nicht von Hand aendern,
...
;
; Schluessel, die im PHP durch au_e() laufen, enthalten KEINE Auszeichnung und
; KEINE Entitaeten: sie wuerden dort ein zweites Mal maskiert und als
; "pr&amp;uuml;fen" auf dem Bildschirm landen.
"""

KOPF_EN = """; Audi Connect - English
;
; GENERATED by Werkzeuge/au_sprache_erzeugen.py - do not edit by hand.
;
...
def maskierte_schluessel(wurzel: Path) -> set:
    """Welche Schluessel laufen im PHP durch au_e()?"""
    treffer = set()
    for f in php_dateien(wurzel):
        t = f.read_text(encoding="utf-8")
        for m in re.finditer(r"au_e\(\s*au_t\('([A-Z0-9_]+\.[A-Z0-9_]+)'\)", t):
            treffer.add(m.group(1))
        # sprintf(au_t('X'), ...) innerhalb von au_e(): der Text selbst wird
        # dann ebenfalls maskiert.
        for m in re.finditer(r"au_e\(\s*sprintf\(\s*au_t\('([A-Z0-9_]+\.[A-Z0-9_]+)'\)", t):
            treffer.add(m.group(1))
    return treffer
...
def benutzte_schluessel(wurzel: Path) -> set:
    ...
    for f in php_dateien(wurzel):
        t = f.read_text(encoding="utf-8")
        for m in re.finditer(r"au_t\('([A-Z0-9_]+\.[A-Z0-9_]+)'\)", t):
            treffer.add(m.group(1))
        for m in re.finditer(r"'(AU_[A-Z]+\.[A-Z0-9_]+|BAUSTEIN\.[A-Z0-9_]+)'", t):
            treffer.add(m.group(1))
...
def ini_schreiben(pfad: Path, kopf: str, texte: dict) -> None:
    ...
    reihenfolge = ["REITER", "LEGENDE", "ALLG", "EINST", "MQTT", "LOX", "BAUSTEIN",
                   "TEST", "LOG", "AU_FELD", "AU_LFELD", "AU_WFELD", "AU_MQTT"]
    zeilen = [kopf]
...
def pruefen(wurzel: Path) -> int:
    ...
    for name, tab in (("DE", DE), ("EN", EN)):
        for k in sorted(maskiert):
            w = tab.get(k, "")
            if "<" in w or "&" in w:
                fehler.append("%s %s laeuft durch au_e(), enthaelt aber Auszeichnung "
